"use client"
import { useGetBySearchQuery } from '@/redux/ProductApi/ProductApi';
...
const SearchPage = ({search}:any) => {
    const router = useRouter()
    const dispatch = useDispatch()
    const {data,isError,isLoading} = useGetBySearchQuery(search);
    console.log(data?.result?.result,'search')
    if(isLoading){
